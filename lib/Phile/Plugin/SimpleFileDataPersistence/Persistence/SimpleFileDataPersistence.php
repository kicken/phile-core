 ...
 */
namespace Phile\Plugin\SimpleFileDataPersistence\Persistence;
...
class SimpleFileDataPersistence implements PersistenceInterface
{
    ...
    {
        if (!$this->has($key)) {
            throw new AbstractException("no data storage for key '{$key}' exists!");
        }
